...
<div class="slide">
    ...
    <div class="col-md-4">
        <article class="img-small col-md-12 col-sm-6 col-xm-12">
            <a href="" title="">
            <img src="{{ url('assets/site/imgs/img2.jpg') }}" alt="" class="img-slide-small">
        ...
        <article class="img-small col-md-12 col-sm-6 col-xm-12">
            <a href="" title="">
            <img src="{{ url('assets/site/imgs/img3.jpg') }}" alt="" class="img-slide-small">
                <h1 class="text-slide">
    ...
    <div class="col-md-8">
        ...
        @for($i = 1; $i <= 10; $i++)
            <article class="post">
                ...
                <img src="{{ url('assets/site/imgs/img1.jpg') }}" alt="Nome Post" class="img-post">
                </div>
